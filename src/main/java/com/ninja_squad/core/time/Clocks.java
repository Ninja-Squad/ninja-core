...
public final class Clocks {
     ...
     * @return a clock that returns the current time + the offset
     */
    public static Clock startingAt(Date time) {
     ...
     */
    public static Clock stoppedAt(Date time) {
    ...
    /**
     * Base class for clocks, which computed the current time as Date and as Calendar from
